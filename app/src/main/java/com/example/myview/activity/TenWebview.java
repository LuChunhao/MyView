...
import com.example.myview.databinding.ActivityTencentWebviewBinding;
...
public class TenWebview extends AppCompatActivity {
    ...
    private static final String TAG = "TenWebview";

    private long currentTime;
    private ActivityTencentWebviewBinding binding;
    private WebSettings webSettings;
    private String webUrl = "https://m.tbdress.com/sales/stylish-boots-h5-3783.html?ug=469f1558-8395-4bed-8d98-2de836dfa39f&flag=1";

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_tencent_webview);
        initView();
    }
