...
public class HeaderScrollHelper {
    ...
    private View getScrollableView() {
        ...
        if (mCurrentScrollableContainer == null) {
            ...
            Log.e("HeaderScrollHelper", "mCurrentScrollableContainer== null ");
            return null;
        }
    ...
    public boolean isTop() {
        ...
        if (scrollableView == null && this.mCurrentScrollableContainer != null) {
...
//            LogUtils.e("firstVisiblePosition"+firstVisiblePosition+"---childAt.getTop() ===>"+childAt.getTop());
    ...
    private boolean isScrollViewTop(ScrollView scrollView) {
        ...
        {
            Log.e("HeaderScrollHelper", "scrollView is null");
        }
        return false;
    }
